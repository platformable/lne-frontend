          ...
          <div className="container mx-auto ">
            ...
            <div className=" mt-10 search-container grid  grid-cols-1 md:flex  gap-5 justify-between">
              <div className="search-box flex  items-center">
                <img
                  src="/client/client_information.svg"
                  alt="search by client icon"
                  className="mr-4"
                />
                ...
                <div className="ml-5 flex gap-x-5 items-center">
                  ...
                  <select
                    name="activeornotactiveusers"
                    id=""
                    className=" border rounded py-3 px-5 border-black"
        ...
        <div className="container mx-auto">
          ...
          <div className="dashboard-clients-container grid md:grid-cols-3 lg:grid-cols-5  md:px-0 px-5 gap-5">
            <Link href="/clients/progress-notes">
              <div className="p-5 flex flex-col gap-5 items-center justify-center text-center mb-2  text-center btn-new-blue rounded shadow-xl rounded cursor-pointer">
                <div className="  ">
                  <button id="myBtn">
