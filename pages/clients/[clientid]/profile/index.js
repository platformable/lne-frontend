...
export default function ClientProfilePage({ data }) {
  ...
  console.log("msa_form_id",data[0].msa_form_id)
  return (<>
    <Layout>
      <section id="client-profile-page-client-information" className="my-5">
      <h3 className="font-black text-center">Client Profile {data.msa_form_id}</h3>
        ...
        <div className="container mx-auto bg-light-blue rounded-xl p-5">
          <div className="client-profile-page-navigation-container grid grid-cols-6 gap-5">
            <Link href={`/clients/${data[0].clientid}/service-action-plan`}>
              ...
              {data[0].services_action_plan_id !==undefined || data[0].services_action_plan_id ==="" ? "Create service action plan" : `Edit Service action plan`}
              </h4>
            </div>
            </Link>
            <Link href={data[0].msa_form_id ?
