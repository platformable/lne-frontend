...
export default function ClientProfilePage({ data }) {
  ...
  return (<>
    <Layout>
          <button 
            onClick={()=>router.back()}
            className="bg-black hover:bg-blue-300 px-5 py-1 rounded text-white inline-block text-xs my-3 ml-10 flex items-center">
      ...
      <section id="client-profile-page-client-information" className="my-10 container mx-auto ">
