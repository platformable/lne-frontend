...
const EditMsaFormPage = ({ data }) => {
  ...
  const [clientData, setClientData] = useState({
    ...
    ComprehensiveRiskBehaviorAssessment:
      data[0].comprehensiveriskbehaviorassessment === "0" ? false : true,
    ...
    AIRSInsuranceInformation:
      data[0].airsinsuranceinformation === "0" ? false : true,
    AIRSInsuranceInformationDate: data[0].airsinsuranceinformationdate || "",
    AIRSSubstanceUseHistory:
      data[0].airssubstanceusehistory === "0" ? false : true,
    ...
    LNEClientGrievancePolicyProcedure:
      data[0].lneclientgrievancepolicyprocedure === "0" ? false : true,
    ...
    LNEEmergencyContactConsent:
      data[0].lneemergencycontactconsent === "0" ? false : true,
    ...
    NYCDOHMHNoticeOfPrivacyPractices:
      data[0].nycdohmhnoticeofprivacypractices === "0" ? false : true,
  ...
  const handleMsaform = () => {
    ...
    axios
      .put(
        `${process.env.NEXT_PUBLIC_SERVER_URL}/msa_forms/${clientData.clientId}/update`,
        {
          clientData,
        }
      )
    ...
    <>
      ...
      <Layout>
        ...
        <div className="container mx-auto bg-white shadow divide-y-2 divide-blue-300 mt-10 rounded-md border-blue">
          ...
          <section id="form" className="gap-x-5 px-10 pt-6 mb-7">
            {/* {TABLE HEAD} */}
            ...
            >
              ...
              <p className="text-center light-blue-bg py-2 text-xl ">
                Date added
              </p>
              <p className="text-center light-blue-bg py-2 text-xl ">
                Dropbox Folder
            ...
            >
              ...
              <div>
                <p className="text-lg">
                  Comprehensive Behavioral Risk Assessment Updates{" "}
                </p>
              </div>
            ...
            >
              ...
              <div>
                <p className="text-lg">CD4/VL Check Reports</p>
              </div>
              <div className="text-center">
            ...
            >
              ...
              <div>
                <p className="text-lg">Initial Treatment Adherence Intake</p>
              </div>
              <div className="text-center">
                {/* {data[0].initialtreatmentadherenceintake === "1" ?
            ...
            >
              ...
              <div>
                <p className="text-lg">Treatment Adherence Updates</p>
              </div>
              <div className="text-center">
            ...
            >
              ...
              <div>
                <p className="text-lg">AIRS Drug Regimen History</p>
              </div>
              <div className="text-center">
            ...
            >
              ...
              <div>
                <p className="text-lg">AIRS HIV Medical Provider History</p>
              </div>
              <div className="text-center">
            ...
            >
              ...
              <div>
                <p className="text-lg">AIRS HIV Status History</p>
              </div>
              <div className="text-center">
            ...
            >
              <div className="form-row-item px-5">
                <input
                  type="checkbox"
                  disabled={
                    data[0].socialdeterminatsofhealthassesment === "1" ? true : false
                  }
                  name=""
                  id=""
                  onChange={() => {
                    clientData.SocialDeterminatsOfHealthAssesmentDate === "" ||
                    clientData.SocialDeterminatsOfHealthAssesmentDate === null
                      ? setClientData({
                          ...clientData,
              ...
              <div className="text-center">
                {/*  {data[0].socialdeterminatsofhealthassesment === "1" ?
              
              <p className="bg-white inline-block px-8 py-1 rounded-lg"> 
              {clientData.SocialDeterminatsOfHealthAssesmentDate.split('T')[0]}</p> :
               } */}
                <input
                  type="date"
                  ...
                  value={
                    clientData.SocialDeterminatsOfHealthAssesmentDate &&
                    clientData.SocialDeterminatsOfHealthAssesmentDate.split("T")[0]
                  }
            ...
            >
              <div className="form-row-item px-5">
                <input
                  type="checkbox"
                  disabled={
                    data[0].chlamydialaboratorypsychologicaltestsinformation === "1" ? true : false
                  }
                  name=""
                  id=""
                  onChange={() => {
                    clientData.ChlamydiaLaboratoryPsychologicalTestsInformationDate === "" ||
                    clientData.ChlamydiaLaboratoryPsychologicalTestsInformationDate === null
                      ? setClientData({
                          ...clientData,
              ...
              <div className="text-center">
                {/*  {data[0].ChlamydiaLaboratoryPsychologicalTestsInformation === "1" ?
              
              <p className="bg-white inline-block px-8 py-1 rounded-lg"> 
              {clientData.ChlamydiaLaboratoryPsychologicalTestsInformationDate.split('T')[0]}</p> :
               } */}
                <input
                  type="date"
                  ...
                  value={
                    clientData.ChlamydiaLaboratoryPsychologicalTestsInformationDate &&
                    clientData.ChlamydiaLaboratoryPsychologicalTestsInformationDate.split("T")[0]
                  }
            ...
            >
              <div className="form-row-item px-5">
                <input
                  type="checkbox"
                  disabled={
                    data[0].syphilislaboratorypsychologicaltestsinformation === "1" ? true : false
                  }
                  name=""
                  id=""
                  onChange={() => {
                    clientData.SyphilisLaboratoryPsychologicalTestsInformationDate === "" ||
                    clientData.SyphilisLaboratoryPsychologicalTestsInformationDate === null
                      ? setClientData({
                          ...clientData,
              ...
              <div className="text-center">
                {/*  {data[0].SyphilisLaboratoryPsychologicalTestsInformation === "1" ?
              
              <p className="bg-white inline-block px-8 py-1 rounded-lg"> 
              {clientData.SyphilisLaboratoryPsychologicalTestsInformationDate.split('T')[0]}</p> :
               } */}
                <input
                  type="date"
                  ...
                  value={
                    clientData.SyphilisLaboratoryPsychologicalTestsInformationDate &&
                    clientData.SyphilisLaboratoryPsychologicalTestsInformationDate.split("T")[0]
                  }
            ...
            >
              <div className="form-row-item px-5">
                <input
                  type="checkbox"
                  disabled={
                    data[0].gonorrhealaboratorypsychologicaltestsinformation === "1" ? true : false
                  }
                  name=""
                  id=""
                  onChange={() => {
                    clientData.GonorrheaLaboratoryPsychologicalTestsInformationDate === "" ||
                    clientData.GonorrheaLaboratoryPsychologicalTestsInformationDate === null
                      ? setClientData({
                          ...clientData,
              ...
              <div className="text-center">
                {/*  {data[0].GonorrheaLaboratoryPsychologicalTestsInformation === "1" ?
              
              <p className="bg-white inline-block px-8 py-1 rounded-lg"> 
              {clientData.GonorrheaLaboratoryPsychologicalTestsInformationDate.split('T')[0]}</p> :
               } */}
                <input
                  type="date"
                  ...
                  value={
                    clientData.GonorrheaLaboratoryPsychologicalTestsInformationDate &&
                    clientData.GonorrheaLaboratoryPsychologicalTestsInformationDate.split("T")[0]
                  }
            ...
            >
              <div className="form-row-item px-5">
                <input
                  ...
                  checked={
                    clientData.LNEClientGrievancePolicyProcedure ? true : false
                  }
                />
              </div>
              <div>
            ...
            >
              <div className="form-row-item px-5">
                <input
                  type="checkbox"
                  disabled={
                    data[0].lneconsentforreleaseofconfidentialinformation ===
                    "1"
                      ? true
                      : false
                  }
            ...
            >
              <div className="form-row-item px-5">
                <input
                  ...
                  checked={
                    clientData.NYCDOHMHNoticeOfPrivacyPractices ? true : false
                  }
                />
              </div>
              <div>
            ...
            >
              <div className="form-row-item px-5">
                <input
                  ...
                  checked={
                    clientData.LinkageRetentionAdherenceForms ? true : false
                  }
                />
              </div>
              <div>
            ...
            >
              <div className="form-row-item px-5">
                <input
                  ...
                  checked={
                    clientData.InternalReferralInformation ? true : false
                  }
                />
              </div>
              <div>
            ...
            >
              ...
              <div className="text-center flex justify-center">
                <a
                  href={
                    data[0]?.support_groups_folder_url
                      ? data[0]?.support_groups_folder_url
                      : ""
                  }
                  target="_blank"
            ...
            >
              ...
              <div className="text-center flex justify-center">
                <a
                  href={data[0]?.idg_folder_url ? data[0]?.idg_folder_url : ""}
                  target="_blank"
                  rel="noreferrer"
                >
                  <img src={"/dropbox_folder.svg"} alt="" width="34" />
