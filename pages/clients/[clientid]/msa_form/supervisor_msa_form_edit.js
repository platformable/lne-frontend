...
const EditSupervisorMSAFormPage = ({ data }) => {
  ...
  const [clientData, setClientData] = useState({
    ...
    AIRSIntakeFormReviewed:data[0].airsintakeformreviewed ==="0" || data[0].airsintakeformreviewed ===null ? false: true,
    AIRSIntakeFormIssues:data[0].airsintakeformissues==="0" || data[0].airsintakeformissues===null ? false: true,
    ...
    ComprehensiveRiskBehaviorAssessmentIssues:data[0].comprehensiveriskbehaviorassessmentissues==="0" || data[0].comprehensiveriskbehaviorassessmentissues===null ? false: true,
    ComprehensiveRiskBehaviorAssessmentReviewed:data[0].comprehensiveriskbehaviorassessmentreviewed==="0" || data[0].comprehensiveriskbehaviorassessmentreviewed===null ? false: true ,
...
StatusChangesFormIssues:data[0].statuschangesformissues ==="0" || data[0].statuschangesformissues ===null? false : true,
    ...
    CD4VLReportsReviewed:data[0].cd4vlreportsreviewed ==="0" || data[0].cd4vlreportsreviewed ===null? false : true, 
    CD4VLReportsIssues:data[0].cd4vlreportsissues ==="0" || data[0].cd4vlreportsissues ===null? false : true, 
    ...
    InitialTreatmentAdherenceIntakeReviewed: data[0].initialtreatmentadherenceintakereviewed ==="0" || data[0].initialtreatmentadherenceintakereviewed ===null? false : true, 
    InitialTreatmentAdherenceIntakeIssues: data[0].initialtreatmentadherenceintakeissues ==="0" || data[0].initialtreatmentadherenceintakeissues ===null? false : true, 
    ...
    TreatmentAdherenceUpdatesReviewed :data[0].treatmentadherenceupdatesreviewed ==="0" || data[0].treatmentadherenceupdatesreviewed ===null? false : true,
TreatmentAdherenceUpdatesIssues:data[0].treatmentadherenceupdatesissues ==="0" || data[0].treatmentadherenceupdatesissues ===null? false : true, 
    ...
    AIRSCollateralInformationReviewed: data[0].airscollateralinformationreviewed=== "0" || data[0].airscollateralinformationreviewed=== null ? false : true,
AIRSCollateralInformationIssues : data[0].airscollateralinformationissues=== "0" || data[0].airscollateralinformationissues=== null ? false : true,
...
AirsDrugRegimenIssues :data[0].airsdrugregimenissues ==="0" || data[0].airsdrugregimenissues ===null ? false : true,
    ...
    AIRSFinancialInformationReviewed:data[0].airsfinancialinformationreviewed=== "0" || data[0].airsfinancialinformationreviewed===null ? false : true, 
AIRSFinancialInformationIssues:data[0].airsfinancialinformationissues=== "0" || data[0].airsfinancialinformationissues===null ? false : true, 
    ...
    AIRSHIVAIDSRiskHistoryReviewed : data[0].airshivaidsriskhistoryreviewed==="0" || data[0].airshivaidsriskhistoryreviewed===null ? false: true, 
AIRSHIVAIDSRiskHistoryIssues : data[0].airshivaidsriskhistoryissues==="0" || data[0].airshivaidsriskhistoryissues===null ? false: true, 
...
AirsHIVMedicalProviderIssues :data[0].airshivmedicalproviderissues==="0" || data[0].airshivmedicalproviderissues===null ? false: true, 
    ...
    AIRSHIVStatusHistoryReviewed:data[0].airshivstatushistoryreviewed==="0" || data[0].airshivstatushistoryreviewed===null ? false: true,  
AIRSHIVStatusHistoryIssues:data[0].airshivstatushistoryissues==="0" || data[0].airshivstatushistoryissues===null ? false: true,  
...
AIRSHCVHistoryIssues:data[0].airshcvhistoryissues=== "0"  || data[0].airshcvhistoryissues=== null ? false : true,  
    ...
    AIRSHousingInformationReviewed:data[0].airshousinginformationreviewed=== "0" || data[0].airshousinginformationreviewed=== null ? false: true, 
AIRSHousingInformationIssues:data[0].airshousinginformationissues=== "0" || data[0].airshousinginformationissues=== null ? false: true, 
    ...
    AIRSInsuranceInformationReviewed : data[0].airsinsuranceinformationreviewed==="0" || data[0].airsinsuranceinformationreviewed===null ? false : true, 
    AIRSInsuranceInformationIssues : data[0].airsinsuranceinformationissues==="0" || data[0].airsinsuranceinformationissues===null ? false : true, 
    ...
    AIRSSubstanceUseHistoryReviewed  : data[0].airssubstanceusehistoryreviewed==="0" || data[0].airssubstanceusehistoryreviewed===null ? false : true, 
AIRSSubstanceUseHistoryIssues : data[0].airssubstanceusehistoryissues==="0" || data[0].airssubstanceusehistoryissues===null ? false : true, 
    ...
    LNEClientRightsReviewed: data[0].lneclientrightsreviewed=== "0"  || data[0].lneclientrightsreviewed=== null ? false : true,
LNEClientRightsIssues :data[0].lneclientrightsissues=== "0"  || data[0].lneclientrightsissues=== null ? false : true,
    ...
    LNEClientGrievancePolicyProcedureReviewed : data[0].lneclientgrievancepolicyprocedurereviewed=== "0" || data[0].lneclientgrievancepolicyprocedurereviewed=== null ? false : true, 
LNEClientGrievancePolicyProcedureIssues: data[0].lneclientgrievancepolicyprocedureissues=== "0" || data[0].lneclientgrievancepolicyprocedureissues=== null ? false : true, 
    ...
    LNEProgramRulesReviewed : data[0].lneprogramrulesreviewed=== "0"  || data[0].lneprogramrulesreviewed=== null ? false : true, 
LNEProgramRulesIssues : data[0].lneprogramrulesissues=== "0"  || data[0].lneprogramrulesissues=== null ? false : true, 
    ...
    LNEEmergencyContactConsentReviewed :data[0].lneemergencycontactconsentreviewed=== "0" || data[0].lneemergencycontactconsentreviewed=== null ? false : true,
LNEEmergencyContactConsentIssues :data[0].lneemergencycontactconsentissues=== "0" || data[0].lneemergencycontactconsentissues=== null ? false : true,
    ...
    LNEConsentForReleaseOfConfidentialInformationReviewed : data[0].lneconsentforreleaseofconfidentialinformationreviewed=== "0" || data[0].lneconsentforreleaseofconfidentialinformationreviewed=== null ? false : true,
LNEConsentForReleaseOfConfidentialInformationIssues : data[0].lneconsentforreleaseofconfidentialinformationissues=== "0" || data[0].lneconsentforreleaseofconfidentialinformationissues=== null ? false : true,
...
HIPAAConsentFormIssues : data[0].hipaaconsentformissues=== "0" || data[0].hipaaconsentformissues=== null ? false : true,
    ...
    NYCDOHMHNoticeOfPrivacyPracticesReviewed : data[0].nycdohmhnoticeofprivacypracticesreviewed=== "0" || data[0].nycdohmhnoticeofprivacypracticesreviewed=== null ? false : true,
NYCDOHMHNoticeOfPrivacyPracticesIssues : data[0].nycdohmhnoticeofprivacypracticesissues=== "0" || data[0].nycdohmhnoticeofprivacypracticesissues=== null ? false : true,
    ...
    LinkageRetentionAdherenceFormsReviewed: data[0].linkageretentionadherenceformsreviewed=== "0" || data[0].linkageretentionadherenceformsreviewed=== null ? false : true,
    LinkageRetentionAdherenceFormsIssues: data[0].linkageretentionadherenceformsissues=== "0" || data[0].linkageretentionadherenceformsissues=== null ? false : true,
    ...
    InternalReferralInformationReviewed: data[0].internalreferralinformationreviewed=== "0" || data[0].internalreferralinformationreviewed=== null ? false : true,
    InternalReferralInformationIssues :data[0].internalreferralinformationissues=== "0" || data[0].internalreferralinformationissues=== null ? false : true,
...
HNSEligibilityFormIssue:data[0].hnseligibilityformissue==="0" || data[0].hnseligibilityformissue===null ? false : true,
    ...
    HNSReadinessFormReviewed:data[0].hnsreadinessformreviewed==="0" || data[0].hnsreadinessformreviewed===null ? false: true, 
    HNSReadinessFormIssues:data[0].hnsreadinessformissues==="0" || data[0].hnsreadinessformissues===null ? false: true, 
    ...
    SupportGroupsReviewed :data[0].supportgroupsreviewed ==="0" || data[0].supportgroupsreviewed === null? false : true,
    SupportGroupsIssues :data[0].supportgroupsissues ==="0" || data[0].supportgroupsissues === null? false : true,
    ...
    IDGFormReviewed :data[0].idgformreviewed ==="0" || data[0].idgformreviewed === null? false : true, 
    IDGFormIssues :data[0].idgformissues ==="0" || data[0].idgformissues === null? false : true, 
    ...
    <><ToastContainer autoClose={2000} />
      <Layout>
        ...
        <div className="container mx-auto">
          <h3 className="font-black text-center my-5">Supervisor Edit MSA FORM</h3>
        </div>
        ...
        <main className="container mx-auto">
          ...
          >
            ...
            >
              ...
              <div>
                <p>Comprehensive Behavioral Risk Assessment <span className="text-red-500">*</span> </p>
              </div>
              <div className="text-center">
                <input
                  type="date"
          ...
          {/*       <p className="text-dark-blue underline">CRBA</p> */}
            ...
            >
              ...
              <div className={`${MSAStyles.dropboxFolderNames} text-center flex justify-center items-center border-l-dark-blue`}>
              <a href={data[0]?.linkage_navigation_folder_url ? data[0]?.action_plans_folder_url : ""} target="_blank" rel="noreferrer">
              <img src={'/dropbox-folder.png'} alt="" width="34"/>
                </a>
                {/* <p className="text-dark-blue underline">Action Plans</p> */}
              </div>
            ...
            >
              ...
              <div className={`${MSAStyles.dropboxFolderNames} text-center flex justify-center items-center border-l-dark-blue`}>
              <a href={data[0]?.cbra_folder_url ? data[0]?.action_plans_folder_url : ""} target="_blank" rel="noreferrer">
              <img src={'/dropbox-folder.png'} alt="" width="34"/>
                </a>
                {/* <p className="text-dark-blue underline">Action Plans</p> */}
              </div>
