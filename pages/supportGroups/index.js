...
const SupportGroups = ({ hcworkers }) => {
  ...
  const submitForm = () => {
    ...
    axios
      .post(`${process.env.NEXT_PUBLIC_SERVER_URL}/support_groups`, form)
      .then((data) => {
        console.log(data);
        notifyMessage("ok");
          ...
          <section className="container mx-auto bg-white rounded-xl shadow-md">
            <div id="form" className="grid grid-cols-1 gap-10  p-7 mb-5">
              ...
              <label className="text-xl font-medium flex flex-col items-start  gap-5">
                ...
                <input
                  type="date"
                  value={form.supportMeetingDate}
                  name="supportMeetingDate"
                  onChange={handleForm}
                  className="border-black rounded p-2 block"
                />
              </label>
              <label className="text-xl font-medium flex flex-col items-start gap-5">
                Start time
              ...
              <label className="text-xl font-medium flex flex-col gap-5">
                ...
                <input
                  type="text"
                  value={form.supportGroupName}
                  name="supportGroupName"
                  onChange={handleForm}
                  className="border-black rounded p-2 block w-full"
                />
              </label>
              <label className="text-xl font-medium flex flex-col gap-5">
                Target audience
