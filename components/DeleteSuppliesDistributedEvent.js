...
const DeleteSuppliesDistributedEvent = ({
  ...
  const handleAuthUserDelete = ({}) => {
    setIsSaving(true);
    axios
      .delete(`${process.env.NEXT_PUBLIC_SERVER_URL}/supplies_distributed`, {
        data: { id },
      })
    ...
    <div className="modal flex items-center ">
      <div className="relative mx-auto bg-yellow-400 py-7 px-10 rounded-md ">
        ...
        <div className="flex flex-col justify-between items-start h-full">
          ...
          <p className="self-center text-center text-lg font-medium ">
            Are you sure you want <br />
            to delete this supplies distributed event?
          </p>
          {!isSaving ? (
