...
const ImpactTrackerModal = ({
  ...
  const createImpactTrackerForm = () => {
    ...
    // if (!isEmpty) {
    axios
      .post(`${process.env.NEXT_PUBLIC_SERVER_URL}/impact_tracker`, {
        impactTracker,
      })
      ...
      .catch(function (error) {
        ...
        setErrorMessage("Somethign went wrong try again");
        ...
        <div className="grid grid-cols-1 justify-items-center pb-4 mt-8 md:max-w-md lg:max-w-lg xl:max-w-xl mx-auto border border-blue-500 bg-white mb-8 rounded">
          <div className="grid grid-cols-1 gap-2">
            <header id="banner-info-top shadow-xl ">
              <div className="flex shadow-md justify-around rounded-lg p-4 m-5 items-center text-blue-500">
                ...
                <p className="w-4/5 text-xs text-blue-500 font-semibold text-justify leading-tight">
                  Please check which of the following topics were mentioned by
                  your client in your latest interaction. If possible, please
                  specify if their situation worsened, remained unchanged, or
                  improved.
                </p>
              </div>
            </header>
            <div className="flex justify-between items-center font-bold mx-6 mb-5">
              <p className="text-xs">
                Did the client mention any of the following:
              </p>
            ...
            <section className="">
              <form className="w-full grid grid-cols-1 gap-3 mb-5">
                <div id="medical-section" className="grid grid-cols-1 gap-2">
                  <div className="flex justify-between">
                    <div className="flex pl-5 items-center">
                      <img
                        src="/impact_tracker/Medical_icon.svg"
                        alt="medical section"
                        width={21}
                      />
                    ...
                    <div className="flex pr-4 w-7/12 items-center">
                      <img
                        src="/impact_tracker/Client_situation_changes_icon.svg"
                        alt="client situation change section"
                        width={21}
                      />

                      <h5 className="font-bold pl-1 text-xs">
                        How has the client`s situation changed?
                      </h5>
                    </div>
                  </div>
                  ...
                  <div className="w-full grid grid-cols-1 gap-1">
                    <div className="flex bg-light-blue items-center py-1 pl-6 pr-3">
                      <span>
                        <input
                          type="checkbox"
                          name="barrierHIVPrimaryCare"
                          onChange={enableFieldfromCheckbox}
                          checked={
                            impactTracker.barrierHIVPrimaryCare !== null
                              ? true
                              : false
                          }
                        />
                      </span>
                      <p className="font-bold text-xs ml-3 w-3/6">
                        Barriers to accessing HIV primary care
                      </p>
                      <div
                        className={`text-xs grid w-11/12 grid-cols-4 ${
                          impactTracker.barrierHIVPrimaryCare === null
                      ...
                      >
                        <span className="flex items-center mx-1">
                          <button
                            className="p-1 px-2 text-xxs flex items-center font-semibold bg-pink-200 rounded-md hover:contrast-125 "
                            type="button"
                            style={
                              impactTracker.barrierHIVPrimaryCare === "Worsened"
                                ? {
                        ...
                        <span className="flex items-center mx-1">
                          <button
                            className="p-1 px-2 text-xxs flex items-center font-semibold bg-yellow-200 rounded-md hover:contrast-125 "
                            type="button"
                            style={
                              impactTracker.barrierHIVPrimaryCare ===
                              "Unchanged"
                                ? {
                                    border: "2px solid lightblue",
                                    filter: "saturate(2.5)",
                        ...
                        <span className="flex items-center mx-1">
                          <button
                            className="p-1 px-2 text-xxs flex items-center font-semibold bg-green-200 rounded-md hover:contrast-125 "
                            type="button"
                            style={
                              impactTracker.barrierHIVPrimaryCare === "Improved"
                                ? {
                                    border: "2px solid lightblue",
                                    filter: "saturate(2.5)",
                                  }
                        ...
                        <span className="flex items-center mx-1">
                          <button
                            ...
                            type="button"
                            style={
                              impactTracker.barrierHIVPrimaryCare === "N/A"
                                ? {
                                    border: "2px solid lightblue",
                                    filter: "saturate(2.5)",
                                  }
                    ...
                    <div className="flex bg-light-blue items-center py-1 pl-6 pr-3">
                      <span>
                        <input
                          ...
                          onChange={enableFieldfromCheckbox}
                          checked={
                            impactTracker.viralLoadCount !== null ? true : false
                          }
                        ></input>
                      </span>
                      <p className="font-bold text-xs ml-3 w-3/6">
                      ...
                      <div
                        className={`text-xs grid w-11/12 grid-cols-4 place-center ${
                          impactTracker.viralLoadCount === null
                            ? "pointer-events-none grayscale"
                            : ""
                        }`}
                      >
                        <span className="flex items-center mx-1">
                          <input
                            className="p-1 px-2 text-xxs flex items-center mr-1 md:mr-2 font-semibold bg-pink-200 rounded-md hover:contrast-125"
                            type="radio"
                            style={
                              impactTracker.viralLoadCount === "<50"
                                ? {
                                    border: "2px solid lightblue",
                                    filter: "saturate(2.5)",
                                  }
                        ...
                        <span className="flex items-center mx-1">
                          <input
                            className="p-1 px-2 text-xxs flex items-center mr-1 md:mr-2 font-semibold bg-yellow-200 rounded-md hover:contrast-125"
                            type="radio"
                            style={
                              impactTracker.viralLoadCount === "100-500"
                                ? {
                                    border: "2px solid lightblue",
                                    filter: "saturate(2.5)",
                                  }
                        ...
                        <span className="flex items-center mx-1">
                          <input
                            className="p-1 px-2 text-xxs flex items-center mr-1 md:mr-2 font-semibold bg-green-200 rounded-md hover:contrast-125"
                            type="radio"
                            style={
                              impactTracker.viralLoadCount === "200+"
                                ? {
                                    border: "2px solid lightblue",
                                    filter: "saturate(2.5)",
                                  }
                        ...
                        <span className="flex items-center mx-1">
                          <input
                            ...
                            type="radio"
                            style={
                              impactTracker.viralLoadCount === "N/A"
                                ? {
                                    border: "2px solid lightblue",
                                    filter: "saturate(2.5)",
                                  }
                    ...
                    <div className="flex bg-light-blue items-center py-1 pl-6 pr-3">
                      <span>
                        <input
                          ...
                          onChange={enableFieldfromCheckbox}
                          checked={
                            impactTracker.CD4Count !== null ? true : false
                          }
                        ></input>
                      </span>
                      ...
                      >
                        ...
                        <span className="flex items-center mx-1">
                          <input
                            ...
                            type="radio"
                            style={
                              impactTracker.CD4Count === "100-500"
                                ? {
                                    border: "2px solid lightblue",
                                    filter: "saturate(2.5)",
                                  }
                ...
                <div
                  id="risky-behaviors-substance-abuse-section"
                  className="grid grid-cols-1 gap-2"
                >
                  <div className="flex pl-5 items-center">
                    <img
                      src="/impact_tracker/Risky_icon.svg"
                      alt="riky behaviors section"
                      width={21}
                    />

                    <h5 className="font-bold pl-1">
                  ...
                  <div className="w-full grid grid-cols-1 gap-1">
                    <div className="flex bg-light-blue items-center py-1 pl-6 pr-3">
                      <span>
                        <input
                          type="checkbox"
                          name="unsafeSexualBehavior"
                          onChange={enableFieldfromCheckbox}
                          checked={
                            impactTracker.unsafeSexualBehavior !== null
                              ? true
                              : false
                          }
                        ></input>
                      </span>
                      <p className="font-bold text-xs ml-3 w-3/6 mr-2">
                    ...
                    <div className="flex bg-light-blue items-center py-1 pl-6 pr-3">
                      <span>
                        <input
                          ...
                          onChange={enableFieldfromCheckbox}
                          checked={
                            impactTracker.substanceAbuse !== null ? true : false
                          }
                        ></input>
                      </span>
                      <p className="font-bold text-xs ml-3 w-3/6">
                      ...
                      <div
                        className={`text-xs grid w-11/12 grid-cols-4 ${
                          impactTracker.substanceAbuse === null
                            ? "pointer-events-none grayscale"
                            : ""
                        }`}
                      >
                        <span className="flex items-center mx-1">
                          <button
                            ...
                            type="button"
                            style={
                              impactTracker.substanceAbuse === "Worsened"
                                ? {
                                    border: "2px solid lightblue",
                                    filter: "saturate(2.5)",
                                  }
                        ...
                        <span className="flex items-center mx-1">
                          <button
                            ...
                            type="button"
                            style={
                              impactTracker.substanceAbuse === "Unchanged"
                                ? {
                                    border: "2px solid lightblue",
                                    filter: "saturate(2.5)",
                                  }
                        ...
                        <span className="flex items-center mx-1">
                          <button
                            ...
                            type="button"
                            style={
                              impactTracker.substanceAbuse === "Improved"
                                ? {
                                    border: "2px solid lightblue",
                                    filter: "saturate(2.5)",
                                  }
                        ...
                        <span className="flex items-center mx-1">
                          <button
                            ...
                            type="button"
                            style={
                              impactTracker.substanceAbuse === "N/A"
                                ? {
                                    border: "2px solid lightblue",
                                    filter: "saturate(2.5)",
                                  }
                ...
                <div
                  id="legal-financial-section"
                  className="grid grid-cols-1 gap-2"
                >
                  <div className="flex pl-5 items-center">
                    <img
                      src="/impact_tracker/Legal_and_Financial_icon.svg"
                      alt="legal and financial section"
                      width={21}
                    />
                    ...
                    <div className="flex bg-light-blue items-center py-1 pl-6 pr-3">
                      <span>
                        <input
                          ...
                          onChange={enableFieldfromCheckbox}
                          checked={
                            impactTracker.legalIssues !== null ? true : false
                          }
                        ></input>
                      </span>
                      <p className="font-bold text-xs ml-3 w-3/6">
                      ...
                      <div
                        className={`text-xs grid w-11/12 grid-cols-4 ${
                          impactTracker.legalIssues === null
                            ? "pointer-events-none grayscale"
                            : ""
                        }`}
                      >
                        <span className="flex items-center mx-1">
                          <button
                            ...
                            type="button"
                            style={
                              impactTracker.legalIssues === "Worsened"
                                ? {
                                    border: "2px solid lightblue",
                                    filter: "saturate(2.5)",
                                  }
                        ...
                        <span className="flex items-center mx-1">
                          <button
                            ...
                            type="button"
                            style={
                              impactTracker.legalIssues === "Unchanged"
                                ? {
                                    border: "2px solid lightblue",
                                    filter: "saturate(2.5)",
                                  }
                        ...
                        <span className="flex items-center mx-1">
                          <button
                            ...
                            type="button"
                            style={
                              impactTracker.legalIssues === "Improved"
                                ? {
                                    border: "2px solid lightblue",
                                    filter: "saturate(2.5)",
                                  }
                ...
                <div id="housing-section" className="grid grid-cols-1 gap-2">
                  <div className="flex pl-5 items-center">
                    <img
                      src="/impact_tracker/Housing_icon.svg"
                      alt="housing section"
                      width={21}
                    />
                  ...
                  <div className="w-full grid grid-cols-1 gap-1">
                    <div className="flex bg-light-blue items-center py-1 pl-6 pr-3">
                      <span>
                        <input
                          type="checkbox"
                          name="unstableHousing"
                          onChange={enableFieldfromCheckbox}
                          checked={
                            impactTracker.unstableHousing !== null
                              ? true
                              : false
                          }
                        ></input>
                      ...
                      >
                        <span className="flex items-center mx-1">
                          <button
                            ...
                            type="button"
                            style={
                              impactTracker.unstableHousing === "Worsened"
                                ? {
                                    border: "2px solid lightblue",
                                    filter: "saturate(2.5)",
                                  }
                        ...
                        <span className="flex items-center mx-1">
                          <button
                            ...
                            type="button"
                            style={
                              impactTracker.unstableHousing === "Unchanged"
                                ? {
                                    border: "2px solid lightblue",
                                    filter: "saturate(2.5)",
                                  }
                        ...
                        <span className="flex items-center mx-1">
                          <button
                            ...
                            type="button"
                            style={
                              impactTracker.unstableHousing === "Improved"
                                ? {
                                    border: "2px solid lightblue",
                                    filter: "saturate(2.5)",
                                  }
                        ...
                        <span className="flex items-center mx-1">
                          <button
                            ...
                            type="button"
                            style={
                              impactTracker.unstableHousing === "N/A"
                                ? {
                                    border: "2px solid lightblue",
                                    filter: "saturate(2.5)",
                                  }
          ...
          {errorMessage && (
            <p className="mt-2 px-5 py-1 font-semibold bg-blue-200/70 rounded-md text-red-600 opacity-80">
              {errorMessage}
            </p>
          )}
        </div>
