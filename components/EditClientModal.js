    ...
    <>
      <div className="modal">
        ...
        <div className="flex justify-end">
              <button onClick={() => setShowEditClientModal(!showEditClientModal)} className="text-white bg-black px-2 py-1">X</button>
            </div>
          <div className="grid grid-cols-1 gap-6 p-5">
            
            <div className="flex items-center gap-4">
              <img src="/add_new_client_icon.svg" alt="" />
            <h1 className="font-black text-white"> Edit Client Information</h1>
